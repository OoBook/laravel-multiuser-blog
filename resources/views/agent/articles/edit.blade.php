...
@section('menu-title', $article->title.' Yazısını Düzenle')
...
@section('content')
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{ route('admin.content.update', $article->id )}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="">Yazı Fotoğrafı</label> <br/>
